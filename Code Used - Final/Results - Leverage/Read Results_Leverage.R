...
setwd("/Users/Michal/Dropbox/UNISG/20. Thesis/4. Code/Code Used - Final/Results - Leverage/")  
...
index = seq(leverage_low_step, leverage_high_step, by = leverage_test_step)
...
Graph_title = "Bankruptcy percentage on bank leverage"
x_lab_title = "Leverage"
y_lab_title = "Bankruptcy percentage"
save_title = "Leverage_Probability"
...
Graph_title = "Asset loss on bank leverage"
y_lab_title = "Asset loss"
save_title = "Leverage_Loss"
